...
//        tvBalance.setText(Cache.currenUser.getData().getBalance()+"元");
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Toast.makeText(PickCashActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                    } else {
                        // 该笔订单真实的支付结果，需要依赖服务端的异步通知。
                        Toast.makeText(PickCashActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
                    }
                    break;
                }
                case SDK_AUTH_FLAG: {
    ...
    public void authV2(View v) {
        ...
        Runnable authRunnable = new Runnable() {
            ...
            public void run() {
                // 构造AuthTask 对象
                AuthTask authTask = new AuthTask(PickCashActivity.this);
                // 调用授权接口，获取授权结果
