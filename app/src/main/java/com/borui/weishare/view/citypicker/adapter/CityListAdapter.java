package com.borui.weishare.view.citypicker.adapter;
...
import com.borui.weishare.view.citypicker.utils.PinyinUtils;
...
//        sections = new String[size];
        for (int index = 0; index < mCities.size(); index++){
            ...
            //上个首字母，如果不存在设为""
            String previousLetter = index ==0 ?"": PinyinUtils.getFirstLetter(mCities.get(index - 1).getPinyin());
...
//                final com.zaaach.citypicker.adapter.HotCityGridAdapter hotCityGridAdapter = new HotCityGridAdapter(mContext);
